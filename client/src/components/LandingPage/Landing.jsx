...
const Landing = (props) => {
  ...
  return (
    <div className={style.landingContainer}>
      <img src="logo-no-background.png" alt="logo" className={style.logoLanging}/>
      <div className={style.textContainer}>
        ...
        <Link to="/home">
            <button onClick={props.goHome} className={style.landingBbutton}>Adopt or Give up for adoption</button>
        </Link>
      </div>
      <img src="AdoptingDog.png" alt="landingPic" className={style.landingPic}/>
    </div>
  )
}
